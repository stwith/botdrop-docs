...
<img class="phone" src="/images/setup/01-choose-agent.png" alt="Choose agent" />
...
<img class="phone" src="/images/setup/02-installing.png" alt="Installing" />

## Step 2: Choose Your AI Model

Select an AI provider and enter your API key.

<img class="phone" src="/images/setup/03-choose-model.png" alt="Choose model" />

Tap **SELECT**, search for your provider (e.g. OpenRouter), and enter your API key.

<img class="phone" src="/images/setup/04-api-key.png" alt="Enter API key" />
...
<img class="phone" src="/images/setup/05-channel-empty.png" alt="Telegram setup" />

Enter the required credentials and tap **CONNECT & START**.

<img class="phone" src="/images/setup/06-channel-filled.png" alt="Telegram filled" />
...
<img class="phone" src="/images/setup/07-dashboard.png" alt="Dashboard" />
