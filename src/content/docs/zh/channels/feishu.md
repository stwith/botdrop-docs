...
![进入开发者后台](/botdrop-docs/images/feishu/01-feishu-dev-console.png)

### 2. 创建企业自建应用

点击「创建企业自建应用」。

![创建应用](/botdrop-docs/images/feishu/02-create-app-button.png)

填写应用名称（比如 "BotDrop"）和描述，选个图标，点创建。

![填写应用信息](/botdrop-docs/images/feishu/03-create-app-form.png)
...
![开通 IM 权限](/botdrop-docs/images/feishu/08-open-im-permissions.png)
...
![发布成功](/botdrop-docs/images/feishu/14-published-success.png)
...
![选择 Channels](/botdrop-docs/images/feishu/16-select-channels.png)
...
![选择飞书](/botdrop-docs/images/feishu/18-select-feishu.png)

### 3. 输入凭证

输入第一部分记下的 App ID 和 App Secret。

![输入凭证](/botdrop-docs/images/feishu/19-enter-credentials.png)

### 4. 选择域名

国内用户选「Feishu (feishu.cn)」。

![选择域名](/botdrop-docs/images/feishu/20-select-domain.png)

### 5. 群组聊天策略

选择「Open」，允许在群组中 @机器人使用。

![群组策略](/botdrop-docs/images/feishu/21-group-chat-policy.png)

### 6. 完成渠道配置

选择「Finished (Done)」。

![完成](/botdrop-docs/images/feishu/22-finished-channels.png)
...
![继续完成](/botdrop-docs/images/feishu/25-continue-done.png)
...
![重启成功](/botdrop-docs/images/feishu/26-restart-feishu-ok.png)
...
![添加事件可用](/botdrop-docs/images/feishu/29-add-event-enabled.png)
...
![重新发布](/botdrop-docs/images/feishu/32-republish-version.png)
...
![搜索机器人](/botdrop-docs/images/feishu/33-search-bot-feishu.png)

手机端也能用：

![手机聊天](/botdrop-docs/images/feishu/34-mobile-chat-demo.jpg)
